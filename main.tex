...
These files were also pre-read before measuring any data, so that they would be in Linux's virtual memory, effectively removing physical disk access from the measurement and ensuring that neither software product is unfairly discounted because by this large bottleneck.
