...
%%                   &              660M &           (Amazon) &            (CERN) &             (CERN) &            (Princeton) &                 (CERN) \\
%% Data transfers:   &                   &                    &                   &                    &                        &                        \\\hline
%% DRAM to {\it CPU} & 18.6 ms/GB        & 
%% DRAM to GPU       & 19.8              &
%% GPU to DRAM       & 19.8              &
%% CPU write unified & 14.5              &
%% CPU read unified  & 14.5              &
%% within GPU        &  4.8              &
%% Calculations:     &                   &                    &                   &                    &                        &                        \\\hline
%% in-place global   &  8.4              &
%% immutable global  &  8.1              &
%% in-place unified  & 12.8              &
%% immutable unified & 11.5              &
%% \end{tabular}
\end{center}
\end{table}
...
%% Host-to-host copy (no GPU)          	21.71 & 43.43 & 43.40	40.96	9.71	4.2
%% Host-to-device copy             	34.56 & 41.11 & 66.12	38.68	9.92	3.9
%% Device-to-host copy            	34.07 & 68.24 & 44.17	65.27	18.18	3.6
%% Host write to unified memory     	21.87 & 40.95 & 67.66	38.49	9.41	4.1
%% Host read from unified memory	22.36 & 70.27 & 72.30	67.34	16.33	4.1
%% Device-to-device copy one GPU)	 2.21 &  1.42 &  1.42	1.78	0.59	3.0
%% Calculations (ms for 1 GB):						
%% In-place operation - x, float32)	 2.45 &  1.57 &  1.59	1.99	0.59	3.3
%% Immutable operatio - x, float32)	 2.35 &  1.56 &  1.58	1.98	0.59	3.4
%% In-place operation on unified memory	15.09 & 13.02 & 20.75	23.37	4.73	4.9
%% Immutable on unified memory    	14.02 & 11.42 & 11.65	21.72	4.03	5.4
